...
for member in members:
    for art in members[member]:
        ...
        interfaces.children['Mommy'].inputs[art].connectedTo = " "+art+" "
        interfaces.children['Mommy'].outputs[art].connectedTo = " "+art+"m "
        ...
        if systems.children['CSVRecorder'].inputs.has_key(art):
            systems.children['CSVRecorder'].inputs[art].connectedTo = " "+art+"1 "
            
systems.children['CSVRecorder'].outputs['Number'].connectedTo = " n "
interfaces.children['Poppy'].inputs['Number'].connectedTo = " n "
interfaces.children['Mommy'].inputs['Number'].connectedTo = " n "
...
interfaces.children['Mommy'].inputs['Duration'].connectedTo = " Delta "
